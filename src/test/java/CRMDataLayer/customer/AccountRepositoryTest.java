...
public class AccountRepositoryTest {
    ...
    void checkRelationshipWorks() {
        ...
        Opportunity opportunity1 = new Opportunity(HYBRID, 2, Status.OPEN);
        ...
        assertEquals(result.getOpportunities().get(0).getProductType(), HYBRID);
        assertEquals(result.getOpportunities().get(1).getStatus(), Status.CLOSED_LOST);
    }
}
